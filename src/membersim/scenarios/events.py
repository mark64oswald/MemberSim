...
class EventDelay(BaseModel):
    ...
    min_value: Optional[int] = Field(None, description="Minimum for random range")
    max_value: Optional[int] = Field(None, description="Maximum for random range")

    def to_timedelta(self, seed: Optional[int] = None) -> timedelta:
...
class ScenarioEvent(BaseModel):
    ...
    depends_on: Optional[str] = Field(None, description="Event ID this depends on")
