...
def create_default_engine(seed: Optional[int] = None) -> ScenarioEngine:
    ...
    def enrollment_handler(member: Member, event: TimelineEvent, context: dict) -> dict:
        return {"type": "enrollment", "member_id": member.member_id}

    def claim_handler(member: Member, event: TimelineEvent, context: dict) -> dict:
        return {"type": "claim", "member_id": member.member_id}

    def quality_handler(member: Member, event: TimelineEvent, context: dict) -> dict:
