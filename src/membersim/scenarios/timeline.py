...
class TimelineEvent(BaseModel):
    ...
    executed_date: Optional[date] = Field(None, description="When event actually executed")
...
class MemberTimeline(BaseModel):
    ...
    end_date: Optional[date] = Field(None, description="Timeline end (if known)")
    ...
    def mark_executed(
        self, timeline_event_id: str, outputs: Optional[dict[str, Any]] = None
    ) -> None:
