...
class MemberSimMCPHandler:
    ...
    def __init__(self) -> None:
        """Initialize the handler with empty storage."""
    ...
    def _list_plans(self, args: dict[str, Any]) -> str:
    ...
    def _list_hedis_measures(self, args: dict[str, Any]) -> str:
        """List HEDIS measures."""
    ...
    def _get_member(self, args: dict[str, Any]) -> str:
        ...
        if member_id not in self._members:
            return json.dumps({"error": f"Member {member_id} not found"})
        return to_json(self._members[member_id])

    def _list_members(self, args: dict[str, Any]) -> str:
        """List all members."""
        summary = [
            {
                "member_id": m.member_id,
                "name": f"{m.name.given_name} {m.name.family_name}",
                "plan": m.plan_code,
            }
