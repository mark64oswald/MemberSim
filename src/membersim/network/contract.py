...
class ProviderContract(BaseModel):
    ...
    termination_date: Optional[date] = Field(None, description="Contract end date")
    ...
    fee_schedule_pct: Optional[Decimal] = Field(Decimal("1.20"), description="Percent of Medicare")
    capitation_rate: Optional[Decimal] = Field(None, description="PMPM if capitated")
