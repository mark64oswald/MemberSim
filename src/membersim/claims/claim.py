...
class ClaimLine(BaseModel):
    ...
    revenue_code: Optional[str] = Field(None, description="Revenue code (institutional)")
    ndc_code: Optional[str] = Field(None, description="Drug code (if applicable)")
...
class Claim(BaseModel):
    ...
    facility_npi: Optional[str] = Field(None, description="Facility NPI (for institutional)")

    # Dates
    service_date: date = Field(..., description="Date of service (or admission)")
    admission_date: Optional[date] = Field(None, description="Admission date (inpatient)")
    discharge_date: Optional[date] = Field(None, description="Discharge date (inpatient)")
    ...
    # Prior auth
    authorization_number: Optional[str] = Field(None, description="Prior auth reference")
